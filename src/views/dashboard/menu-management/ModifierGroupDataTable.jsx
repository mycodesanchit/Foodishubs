...
const ModifierGroupDataTable = props => {
  ...
  // Fetch Data
  // Fetch Data with Dummy Data
  const getAllSuspendedUsers = async () => {
    // Abort previous request logic
    ...
    try {
      ...
      const vendorMinimumThresholds = dummyResponse?.data?.response?.thresHoldRequests || []
      const meta = dummyResponse?.data?.meta || {}
      ...
      // Handle empty state on last page
      ...
      if (error.name !== 'AbortError') {
        ...
        toastError('Error fetching dummy data')
      }
    }
