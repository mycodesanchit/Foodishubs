...
const OpenDialogOnElementClick = props => {
  // Props
  const { element: Element, dialog: Dialog, elementProps, dialogProps, setDishCreateData } = props
  ...
  return (
    <>
      ...
      <Dialog open={open} setOpen={setOpen} {...dialogProps} setDishCreateData={setDishCreateData} />
    </>
  )
}
